...
function createMesh(geometry: any, material: any, x: any, y: any, z: any, name : any, layer: any) {
...
function onMouseDown(event: any) {
  ...
  if (intersections.length > 0) {
    ...
    if (selectedObject.material instanceof THREE.MeshLambertMaterial) { // Ensure material is MeshLambertMaterial
      (selectedObject.material as THREE.MeshLambertMaterial).color = color;
